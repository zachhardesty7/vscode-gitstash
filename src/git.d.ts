// source: https://github.com/microsoft/vscode/blob/dd48c7f264782fc16486381e8792f79a3f7a19fa/extensions/git/src/api/git.d.ts
...
export interface Change {
  /**
   * Returns either `originalUri` or `renameUri`, depending on whether this change is a
   * rename change. When in doubt always use `uri` over the other two alternatives.
   */
  readonly uri: Uri
...
export interface LogOptions {
   ...
   * "0a47c67f0fb52dd11562af48658bc1dff1d75a38..0bb4bdea78e1db44d728fd6894720071e303304f"
   */
...
export interface CommitOptions {
  ...
  verbose?: boolean
  /**
   * string - execute the specified command after the commit operation undefined -
   * execute the command specified in git.postCommitCommand after the commit operation
...
export interface GitExtension {
   ...
   * [GitExtension.onDidChangeEnablement](#GitExtension.onDidChangeEnablement) event to
   * know when the extension becomes enabled/disabled.
   *
